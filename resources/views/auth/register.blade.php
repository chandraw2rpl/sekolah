...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('backend-template/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <!-- Theme style -->
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('register') }}" method="post"> @csrf
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control form-control-user" id="password-confirm" placeholder="Retype password" required name="password_confirmation">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-lock"></span>
                            </div>
